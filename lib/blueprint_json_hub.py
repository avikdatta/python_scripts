...
from ihec_json_hub import Ihec_json_hub

class Blueprint_json_hub(Ihec_json_hub):
...
if __name__=='__main__':
  ...
  bp_json = Blueprint_json_hub( hub_description   = 'hub',
                                index_file        = '/home/pi/python/pr7/work/test.index',
                                analysis_file     = '/home/pi/json_trackhub/trackhub/analysis_info.txt',
                                epirr_file        = '/home/pi/json_trackhub/trackhub/epirr_20160818.index', 
                                exp_key_name      = 'EXPERIMENT_ID',
                                file_key_name     = 'FILE',
                                sample_key_name   = 'SAMPLE_ID',
                                epirr_key_name    = 'EPIRR_ID',
                                analysis_key_name = 'FILE_TYPE',
                                file_type_key     = 'FILE_TYPE',
                                url_prefix        = 'http://ftp.ebi.ac.uk/pub/databases/',
                              )
  (dataset,sample) = bp_json.get_json_data()
  print(sample)
